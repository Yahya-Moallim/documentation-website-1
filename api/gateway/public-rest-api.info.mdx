...
description: "All the endpoints below have a prefix of `https://gate.dineropay.com/api/v1/` (e.g. `POST https://gate.dineropay.com/api/v1/purchases/`)."
...
All the endpoints below have a prefix of `https://gate.dineropay.com/api/v1/` <br></br>
(e.g. `POST https://gate.dineropay.com/api/v1/purchases/`).
