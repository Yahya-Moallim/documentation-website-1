...
> One optional parameter you can pass in the request body `paid_on` to <u>indicate when this transaction was paid by default the date will the time when you send a `mark_as_paid` request</u>