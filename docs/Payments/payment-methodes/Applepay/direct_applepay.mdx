...
:::note
In order to work with direct applepay you will have to use [S2S API](/integration/s2s)
:::
...
:::note
Before using Apple Pay via [S2S API](/integration/s2s) , you should review next section carefully.
