...
:::note
In order to work with direct applepay you will have to use [S2S API](https://docs.dineropay.com/Integration/Server%20To%20Server/s2s_apm#apple-pay)
:::
...
:::note
Before using Apple Pay via [S2S API](https://docs.dineropay.com/Integration/Server%20To%20Server/s2s_apm#apple-pay) , you should review next section carefully.
