...
> - Make sure to follow the steps [here](../../get-started#making-your-first-payment-as-easy-as-following-the-below-steps)<br></br>
...
> 1. Create a Authenticate <u>[object](../../api/gateway/authentication-request)</u> as json
...
> 5. Receive the response either via `callback_notification` or `success_url`
