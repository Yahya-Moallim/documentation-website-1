...
For details on how to use S2S SPI [visit](https://docs.rafinita.com/s2s_apm#apple-pay).
S2S dose not use json for it's API requests all request should be send as `Content-Type: multipart/form-data.`
:::
